class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        for (let i = 0; i < 3; i++){
            ...
            let plat = this.platforms.create(this.cameras.main.centerX, this.lastPlatformSpawn, 'platform');
    ...
    spawnCloud(){
        this.lastPlatformSpawn = this.lastPlatformSpawn - Phaser.Math.RND.integerInRange(100, 600);
        let platX = Phaser.Math.RND.integerInRange(0, this.cameras.main.displayWidth * 0.67) + this.cameras.main.displayWidth * 0.33/2;
        let plat = this.platforms.create(platX, this.lastPlatformSpawn, 'platform');
        plat.setDisplaySize(this.cameras.main.displayWidth * 0.3, 100);
        plat.setScale(plat.scaleX, plat.scaleX);
        plat.refreshBody();
